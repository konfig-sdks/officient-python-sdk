...
class AuthenticationGetAccessTokenRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code", "client_id", "client_secret", "grant_type", "refresh_token", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["code", "client_id", "client_secret", "grant_type", "refresh_token", ], str]):
