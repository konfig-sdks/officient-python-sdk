...
class AuthenticationGetAccessTokenResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["access_token", "expires_in", "token_type", "scope", "refresh_token", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["access_token", "expires_in", "token_type", "scope", "refresh_token", ], str]):
