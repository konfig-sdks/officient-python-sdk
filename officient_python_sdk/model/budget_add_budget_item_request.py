...
class BudgetAddBudgetItemRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["budget_type", "maximum", "year", "employee_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["budget_type", "maximum", "year", "employee_id", ], str]):
