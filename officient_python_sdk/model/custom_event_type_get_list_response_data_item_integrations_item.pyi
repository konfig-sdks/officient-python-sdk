...
class CustomEventTypeGetListResponseDataItemIntegrationsItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["app", "code", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["app", "code", ], str]):
    ...
    ) -> 'CustomEventTypeGetListResponseDataItemIntegrationsItem':
