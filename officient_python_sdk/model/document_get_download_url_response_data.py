...
class DocumentGetDownloadUrlResponseData(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["download_url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["download_url", ], str]):
