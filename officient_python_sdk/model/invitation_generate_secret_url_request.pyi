...
class InvitationGenerateSecretUrlRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["person_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["person_id", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        person_id: typing.Union[MetaOapg.properties.person_id, str, ],
