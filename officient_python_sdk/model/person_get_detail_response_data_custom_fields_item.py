...
class PersonGetDetailResponseDataCustomFieldsItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["custom_field_id", "custom_field_name", "type", "value", "value_name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["custom_field_id", "custom_field_name", "type", "value", "value_name", ], str]):
    ...
    ) -> 'PersonGetDetailResponseDataCustomFieldsItem':
