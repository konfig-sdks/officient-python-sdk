...
class PersonGetDetailResponseDataEmergencyContact(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "relation", "phone", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "relation", "phone", ], str]):
