...
class PersonGetPersonalDataChangesResponseLogsItemChangedValuesAddressCountryCode(
    schemas.DictSchema
):
    """
    ...
    ) -> 'PersonGetPersonalDataChangesResponseLogsItemChangedValuesAddressCountryCode':
