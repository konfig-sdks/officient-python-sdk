...
class PersonGetWageHistoryResponseDataItemCustomPayrollData(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["contract_type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["contract_type", ], str]):
    ...
    ) -> 'PersonGetWageHistoryResponseDataItemCustomPayrollData':
