...
class PersonGetYearlyCalendarResponseDataTimeOffItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def events() -> typing.Type['PersonGetYearlyCalendarResponseDataTimeOffItemEvents']:
                return PersonGetYearlyCalendarResponseDataTimeOffItemEvents
            __annotations__ = {
                "date": date,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["events"]) -> 'PersonGetYearlyCalendarResponseDataTimeOffItemEvents': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["events"]) -> typing.Union['PersonGetYearlyCalendarResponseDataTimeOffItemEvents', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        events: typing.Union['PersonGetYearlyCalendarResponseDataTimeOffItemEvents', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'PersonGetYearlyCalendarResponseDataTimeOffItem':
