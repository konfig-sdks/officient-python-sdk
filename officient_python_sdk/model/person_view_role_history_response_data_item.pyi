...
class PersonViewRoleHistoryResponseDataItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "role_name", "start_date", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "role_name", "start_date", ], str]):
    ...
    ) -> 'PersonViewRoleHistoryResponseDataItem':
