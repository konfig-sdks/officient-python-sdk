...
class VehicleGetDetailResponseDataYearlyCost(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["base", "operational", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["base", "operational", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        operational: typing.Union[MetaOapg.properties.operational, str, schemas.Unset] = schemas.unset,
