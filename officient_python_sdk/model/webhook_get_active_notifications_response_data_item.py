...
class WebhookGetActiveNotificationsResponseDataItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "event", "target_url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "event", "target_url", ], str]):
    ...
    ) -> 'WebhookGetActiveNotificationsResponseDataItem':
