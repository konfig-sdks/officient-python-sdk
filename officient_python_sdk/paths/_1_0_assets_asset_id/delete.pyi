...
from officient_python_sdk.model.asset_remove_response import AssetRemoveResponse as AssetRemoveResponseSchema

from officient_python_sdk.type.asset_remove_response import AssetRemoveResponse

from ...api_client import Dictionary
from officient_python_sdk.pydantic.asset_remove_response import AssetRemoveResponse as AssetRemoveResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = AssetRemoveResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: AssetRemoveResponse
...
class Remove(BaseApi):
    ...
    async def aremove(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AssetRemoveResponsePydantic:
        raw_response = await self.raw.aremove(
            asset_id=asset_id,
            **kwargs,
        )
        if validate:
            return AssetRemoveResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AssetRemoveResponsePydantic, raw_response.body)
