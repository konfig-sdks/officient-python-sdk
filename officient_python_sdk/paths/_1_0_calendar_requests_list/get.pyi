...
class BaseApi(api_client.Api):
    ...
    def _list_requests_mapped_args(
        self,
    ...
    async def _alist_requests_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/1.0/calendar/requests/list',
            headers=_headers,
        )
...
class ListRequestsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_requests(
        self,
        page: typing.Optional[str] = None,
        status: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._list_requests_mapped_args(
            page=page,
            status=status,
        )
        return await self._alist_requests_oapg(
    ...
    def list_requests(
        ...
        return self._list_requests_oapg(
            query_params=args.query,
        )

class ListRequests(BaseApi):
    ...
    async def alist_requests(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_requests(
            page=page,
            status=status,
            **kwargs,
        )
    ...
    def list_requests(
        ...
        raw_response = self.raw.list_requests(
            page=page,
            status=status,
        )
        if validate:
