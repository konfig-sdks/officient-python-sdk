    ...
    async def _alist_related_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/1.0/documents/{object_type}/{object_id}/list',
            headers=_headers,
        )
...
class ListRelatedRaw(BaseApi):
    ...
    async def alist_related(
        ...
        **kwargs,
        ...
        args = self._list_related_mapped_args(
            object_type=object_type,
            object_id=object_id,
            page=page,
        )
        return await self._alist_related_oapg(
    ...
    def list_related(
        ...
        return self._list_related_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListRelated(BaseApi):
    ...
    async def alist_related(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_related(
            object_type=object_type,
            object_id=object_id,
            page=page,
            **kwargs,
    ...
    def list_related(
        ...
        raw_response = self.raw.list_related(
            object_type=object_type,
            object_id=object_id,
            page=page,
        )
