...
class RequiredExpenseAddExpenseWithCategoryRequest(TypedDict):
...
class OptionalExpenseAddExpenseWithCategoryRequest(TypedDict, total=False):
    ...
    dates: ExpenseAddExpenseWithCategoryRequestDates
...
class ExpenseAddExpenseWithCategoryRequest(RequiredExpenseAddExpenseWithCategoryRequest, OptionalExpenseAddExpenseWithCategoryRequest):
    pass
